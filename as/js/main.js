                       ...
                       `
                         <div class="col-md-3 box">
                           <div class="movieBox">
                             <img src="${Poster}" alt="poster" width="210" height="315" class="img">
                             <div class="browse-movie-bottom">
                                 <a href="#" onclick="movieSelected('${movie.imdbID}')" class="browse-movie-title">${movie.Title}</a>
                                 <div class="browse-movie-year">${Year}</div>
                                 <button type="submit" class="button" onclick="movieSelected1('${movie.imdbID}')">Movie Details</button>
                             </div>
                             </div>
                         </div>
                 `
...
/*function getMovie() {
    ...
    //test id -> 299536
    axios.get(`https://api.themoviedb.org/3/movie/${tvId}?api_key=5ec279387e9aa9488ef4d00b22acc451`) 
...
// top tv show
function getopTv() {
    axios.get('https://api.themoviedb.org/3/tv/top_rated?api_key=5ec279387e9aa9488ef4d00b22acc451&language=en-US&page=1')
        .then((response) => {
            console.log(response);
                ...
                output += `
                        <div class="col-md-3 box">
                          <div class="movieBox">
                            <img src="${poster}" alt="poster" width="210" height="315" class="img">
                            <div class="browse-movie-bottom">
                                <a href="#" onclick="movieSelected('${movies[index].id}')" class="browse-movie-title">${movies[index].name}</a>
                                <div class="browse-movie-year">${year}</div>
                                <button type="submit" class="button" onclick="movieSelected('${movies[index].id}')">Movie Details</button>
                            </div>
                            </div>
